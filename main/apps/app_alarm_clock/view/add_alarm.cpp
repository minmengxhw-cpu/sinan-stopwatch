...
constexpr uint32_t _selector_color          = LACQUER;
constexpr uint32_t _selector_selected_color = BRONZE_D;
constexpr uint32_t _ok_color                = MALACHITE;
constexpr uint32_t _ok_text_color           = INK;
