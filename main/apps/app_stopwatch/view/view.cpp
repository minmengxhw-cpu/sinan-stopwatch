...
static const uint32_t _color_status_bar_clock = BRONZE;
static const uint32_t _color_elapsed_time     = SILK;
static const uint32_t _color_panel_info       = LACQUER;
static const uint32_t _color_panel_laps       = LACQUER;
static const uint32_t _color_no_lap_label     = SILK_D;
static const uint32_t _color_divider_info     = BRONZE_D;
